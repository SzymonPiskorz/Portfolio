...
void operator >> (const YAML::Node& targetNode, TargetData& target)
{
	...
	target.m_randomOffset = targetNode["position"]["randomOffset"].as<float>();
	target.m_rotation = targetNode["rotation"].as<double>();
	target.m_spawnTime = targetNode["spawnTime"].as<int>();
}
...
////////////////////////////////////////////////////////////
/// Exercise 2: line 60 calls this function. This function sets the position of the tank
...
void operator >> (const YAML::Node& levelNode, LevelData& level)
{
	...
	const YAML::Node& targetsNode = levelNode["target"].as<YAML::Node>();
